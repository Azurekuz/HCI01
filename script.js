...
function executeDrag(e){
    ...
    if(parseInt(sliderDial[0].style.left.substring(0, sliderDial[0].style.left.length - 2)) >= 35 && parseInt(sliderDial[0].style.left.substring(0, sliderDial[0].style.left.length - 2)) <= 300
    && currentXPos >= 35 && currentXPos <= 300){
